...
enum AppScreenshotAny: AppScreenshot {
...
enum AppScreenshotIPad: AppScreenshot {
    static let configuration = AppScreenshotConfiguration(sizes: AppScreenshotSize.iPadAll)
}
enum AppScreenshotIPadMini: AppScreenshot {
    static let configuration = AppScreenshotConfiguration(sizes: AppScreenshotSize.iPadMiniAll)
}
enum AppScreenshotIpadPro11M4: AppScreenshot {
    static let configuration = AppScreenshotConfiguration(sizes: AppScreenshotSize.iPadPro11M4All)
}
enum AppScreenshotIpadAir11M2: AppScreenshot {
    static let configuration = AppScreenshotConfiguration(sizes: AppScreenshotSize.iPadAir11M2All)
}
enum AppScreenshotIpadPro13M4: AppScreenshot {
    static let configuration = AppScreenshotConfiguration(sizes: AppScreenshotSize.iPadPro13M4All)
}
enum AppScreenshotIpadAir13M2: AppScreenshot {
    static let configuration = AppScreenshotConfiguration(sizes: AppScreenshotSize.iPadAir13M2All)
}
enum AppScreenshotIPhone14: AppScreenshot {
    static let configuration = AppScreenshotConfiguration(sizes: AppScreenshotSize.iPhone14All)
}
enum AppScreenshotIPhone16Pro: AppScreenshot {
    static let configuration = AppScreenshotConfiguration(sizes: AppScreenshotSize.iPhone16ProAll)
}
enum AppScreenshotIPhone16: AppScreenshot {
    static let configuration = AppScreenshotConfiguration(sizes: AppScreenshotSize.iPhone16All)
}
enum AppScreenshotIPhone15Pro: AppScreenshot {
    static let configuration = AppScreenshotConfiguration(sizes: AppScreenshotSize.iPhone15ProAll)
}
enum AppScreenshotIPhone15: AppScreenshot {
    static let configuration = AppScreenshotConfiguration(sizes: AppScreenshotSize.iPhone15All)
}
enum AppScreenshotIPhone14Pro: AppScreenshot {
    static let configuration = AppScreenshotConfiguration(sizes: AppScreenshotSize.iPhone14ProAll)
}
enum AppScreenshotIPhone16ProMax: AppScreenshot {
    static let configuration = AppScreenshotConfiguration(sizes: AppScreenshotSize.iPhone16ProMaxAll)
}
enum AppScreenshotIPhone16Plus: AppScreenshot {
    static let configuration = AppScreenshotConfiguration(sizes: AppScreenshotSize.iPhone16PlusAll)
}
enum AppScreenshotIPhone15ProMax: AppScreenshot {
    static let configuration = AppScreenshotConfiguration(sizes: AppScreenshotSize.iPhone15ProMaxAll)
}
enum AppScreenshotIPhone15Plus: AppScreenshot {
    static let configuration = AppScreenshotConfiguration(sizes: AppScreenshotSize.iPhone15PlusAll)
}
enum AppScreenshotIPhone14ProMax: AppScreenshot {
    static let configuration = AppScreenshotConfiguration(sizes: AppScreenshotSize.iPhone14ProMaxAll)
}

extension AppScreenshot {
    @MainActor static func body(environment: AppScreenshotEnvironment) -> some View {
        VStack {
            DeviceView {
                NavigationStack {
                    VStack {
            ...
            .statusBarShown()
            .frame(width: environment.screenshotSize.width * 0.9, height: environment.screenshotSize.height * 0.9)
        }.background(.orange)
    }
}
